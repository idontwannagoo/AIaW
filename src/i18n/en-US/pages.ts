export default {
  accountPage: {
    ...
    amount: 'Amount',
    importStatusHeader: 'Migration Status',
    importPhaseQueued: 'Queued, waiting to start',
    importPhaseUploading: 'Uploading',
    importPhaseAssembling: 'Assembling parts',
    importPhaseParsing: 'Parsing',
    importPhasePhaseB: 'Importing workspaces / dialogs / assistants',
    importPhasePhaseC: 'Importing message text',
    importPhasePhaseD: 'Importing attachments',
    importPhaseDone: 'Done',
    importPhaseFailed: 'Failed',
    importPhaseCancelled: 'Cancelled',
    importRowsProgress: 'Rows: {processed} / {total}',
    importBlobsProgress: 'Attachments: {processed} / {total}',
    importBackgroundNotice: 'You may close the browser; we will notify you when processing finishes.',
    importCancelButton: 'Cancel Import',
    importDismissButton: 'Dismiss',
    importErrorPrefix: 'Error: '
  },
  modelPricing: {
