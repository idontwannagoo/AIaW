export default {
  accountPage: {
    ...
    amount: '數量',
    importStatusHeader: '遷移狀態',
    importPhaseQueued: '已排隊，等待處理',
    importPhaseUploading: '上傳中',
    importPhaseAssembling: '彙整分片中',
    importPhaseParsing: '解析中',
    importPhasePhaseB: '導入工作區/對話/助手',
    importPhasePhaseC: '導入訊息文本',
    importPhasePhaseD: '導入附件',
    importPhaseDone: '已完成',
    importPhaseFailed: '失敗',
    importPhaseCancelled: '已取消',
    importRowsProgress: '行：{processed} / {total}',
    importBlobsProgress: '附件：{processed} / {total}',
    importBackgroundNotice: '您可以關閉瀏覽器，處理完會通過通知告知。',
    importCancelButton: '取消導入',
    importDismissButton: '關閉',
    importErrorPrefix: '錯誤：'
  },
  modelPricing: {
    modelPrice: '模型價格',
