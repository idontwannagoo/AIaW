export default {
  accountPage: {
    ...
    amount: '数量',
    importStatusHeader: '迁移状态',
    importPhaseQueued: '已排队，等待处理',
    importPhaseUploading: '上传中',
    importPhaseAssembling: '汇总分片中',
    importPhaseParsing: '解析中',
    importPhasePhaseB: '导入工作区/对话/助手',
    importPhasePhaseC: '导入消息文本',
    importPhasePhaseD: '导入附件',
    importPhaseDone: '已完成',
    importPhaseFailed: '失败',
    importPhaseCancelled: '已取消',
    importRowsProgress: '行：{processed} / {total}',
    importBlobsProgress: '附件：{processed} / {total}',
    importBackgroundNotice: '您可以关闭浏览器，处理完会通过通知告知。',
    importCancelButton: '取消导入',
    importDismissButton: '关闭',
    importErrorPrefix: '错误：'
  },
  modelPricing: {
    modelPrice: '模型价格',
