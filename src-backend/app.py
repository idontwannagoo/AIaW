...
def _enable_backend_data_api(app: FastAPI) -> None:
    ...
    from data.routers import artifacts as artifacts_router
    ...
    from data.routers import messages as messages_router
    ...
    from data.routers import workspaces as workspaces_router
